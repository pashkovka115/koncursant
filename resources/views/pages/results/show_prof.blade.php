            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="contests-menu">
                        <ul>
                            <li><a href="{{ route('front.results.index_free') }}">Бесплатные конкурсы</a></li>
                            <li><span>Конкурсы с участием<br /> профессионального жюри</span></li>
                        </ul>
                    </div>
                    <div class="years-menu">
                        <ul>
                            @foreach($years as $year)
                                <li><a href="{{ route('front.results.show_prof', ['competition_slug' => $competition->slug, 'year_bid' => $year]) }}">{{ $year }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="row">
                            ...
                            <div class="aside">
                                <div class="quarter-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="{{ route('front.results.show_prof', $parameters) }}">— I КВАРТАЛ</a></li>
                                        <?php $parameters['quarter'] = 2; ?>
                                        <li><a href="{{ route('front.results.show_prof', $parameters) }}">— II КВАРТАЛ</a></li>
                                        <?php $parameters['quarter'] = 3; ?>
                                        <li><a href="{{ route('front.results.show_prof', $parameters) }}">— III КВАРТАЛ</a></li>
                                        <?php $parameters['quarter'] = 4; ?>
                                        <li><a href="{{ route('front.results.show_prof', $parameters) }}">— IV КВАРТАЛ</a></li>
                                    </ul>
                                </div>
