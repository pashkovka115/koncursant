                ...
                <div class="col-lg-12">
                    ...
                    <div class="years-menu">
                        <ul>
                            ...
                            <li><a href="{{ route('front.results.index_prof', ['year' => $year]) }}">{{ $year }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="wrapper">
                        ...
                        <div class="result-box">
                            <div class="image">
                                <a href=""><img src="{{ asset('storage/' . $competition[0]['competition_img']) }}" alt=""></a>
                            </div>
                            <div class="title">
                                <a href="{{ route('front.results.show_prof', [
                            ...
                            <div class="quarter-menu">
                                ...
                                echo '<ul>';
                                    foreach($quarters as $quarter){
                                        echo "<li><a href='". route('front.results.show_prof', [
                                                'competition_slug' => $competition[0]['competition_slug'],
                                                'year_bid' => $competition[0]['year_bid'],
                                                'quarter' => $quarter
                                            ]) ."'>";
