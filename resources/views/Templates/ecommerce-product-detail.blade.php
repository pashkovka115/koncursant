...
@component('components.breadcrumb')
    ...
    @slot('li_2') Product Details @endslot
@endcomponent
<!-- Start row -->
<div class="row">
    <div class="col-lg-12">
                                ...
                                <div class="col-3">
                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <a class="nav-link" id="product-2-tab" data-toggle="pill" href="#product-2" role="tab">
                                            <img src="{{ URL::asset('/assets/images/product/img-5.png')}}" alt="" class="img-fluid mx-auto d-block tab-img rounded">
                                        </a>
                                        ...
                                        <a class="nav-link" id="product-4-tab" data-toggle="pill" href="#product-4" role="tab">
                                            <img src="{{ URL::asset('/assets/images/product/img-4.png')}}" alt="" class="img-fluid mx-auto d-block tab-img rounded">
                                        </a>
                                    </div>
                                </div>
